...
import { DollarSign, Eye, Users, ShoppingCart, MapPin, Calendar, Store } from 'lucide-react';
import { StatsData, StoreInfo } from '@/types';
...
export default function StatsCards({ stats, storeInfo }: StatsCardsProps) {
    ...
    <div className="w-full">
      ...
      <div className="mb-6">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-4">
          ...
          {/* 店铺信息卡片 */}
          {storeInfo && (
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-xl p-4 lg:p-6 shadow-sm min-w-0">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div className="min-w-0 flex-1">
                    <p className="text-xs text-gray-500 mb-1">店铺地址</p>
      ...
      <div className="mt-6 sm:mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
        <div className="bg-white rounded-lg border border-gray-200 p-4">
          ...
          <div className="space-y-2">
            ...
            <div className="flex justify-between text-xs">
              <span className="text-gray-600">入店人数</span>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-4">
          ...
          <div className="space-y-2">
            ...
            <div className="flex justify-between text-xs">
              <span className="text-gray-600">入店转化率</span>
