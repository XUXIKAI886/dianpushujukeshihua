          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-3">
              ...
              <div className="hidden sm:block">
                <h1 className="text-xl font-bold text-gray-900">呈尚策划 美团数据可视化</h1>
                <p className="text-sm text-gray-500">美团外卖数据可视化分析系统</p>
              </div>
              <div className="sm:hidden">
                <h1 className="text-lg font-bold text-gray-900">美团数据分析</h1>
            ...
            <div className="flex items-center space-x-2 sm:space-x-6">
              ...
              {appState.uploadStatus === 'success' && (
                <button
                  onClick={handleReset}
                  className="flex items-center space-x-1 sm:space-x-2 px-2 sm:px-3 py-2 text-sm font-medium text-yellow-600 hover:text-yellow-700 hover:bg-yellow-50 rounded-lg transition-colors"
                >
          ...
          <div className="text-center py-8 sm:py-12 animate-fade-in">
            <div className="max-w-3xl mx-auto">
              ...
              <p className="text-base sm:text-lg text-gray-600 mb-6 sm:mb-8 px-4 sm:px-0">
                上传您的美团外卖Excel营业数据文件，即可获得专业的数据分析和可视化图表
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-8 sm:mb-12 px-4 sm:px-0">
                <div className="text-center p-4 sm:p-6 bg-white rounded-lg shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-yellow-100 rounded-lg flex items-center justify-center mx-auto mb-3 sm:mb-4">
                    <span className="text-xl sm:text-2xl">📊</span>
                  </div>
                  <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2">智能分析</h3>
                  <p className="text-sm sm:text-base text-gray-600">自动解析美团数据并生成6种专业图表</p>
                </div>
                ...
                <div className="text-center p-4 sm:p-6 bg-white rounded-lg shadow-sm border border-gray-100 hover:shadow-md transition-shadow sm:col-span-2 lg:col-span-1">
                  ...
                  <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2">AI分析</h3>
                  <p className="text-sm sm:text-base text-gray-600">智能生成专业运营分析报告</p>
                </div>
              </div>
            </div>
          </div>
